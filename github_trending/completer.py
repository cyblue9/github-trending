...
class Completer(Completer):
    ...
    def completing_subcommand_option_util(self, subcommand, words):
        """Determine if we are currently completing an option.

        Called by completing_subcommand_option as a utility method.

        :type subcommand: str
        :param subcommand: The subcommand in the elements of ARGS_OPTS_LOOKUP.
        ...
        """
        # EXample: Return True for: gh view 0 --comm
        if len(words) > 3:
